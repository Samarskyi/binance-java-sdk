...
public interface BinanceApiRestClient {
	 ...
	 * Get 24 hour price change statistics.
	 *
	 * @param symbols ticker symbol (e.g. ETHBTC)
	 */
	List<TickerStatistics> get24HrPriceStatisticsNew(String symbols);
	 ...
	 */
	List<Trade> getMyTrades(String symbol, Integer limit, Long fromId, Long orderId, Long recvWindow, Long timestamp);
